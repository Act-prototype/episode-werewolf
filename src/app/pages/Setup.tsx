      ...
      <div className="w-full max-w-[420px] min-h-screen bg-white flex flex-col shadow-xl">
        ...
        <div className="relative bg-gradient-to-br from-violet-600 via-purple-600 to-fuchsia-600 px-6 py-10 overflow-hidden">
          ...
          <div className="relative text-center">
            ...
            <p className="text-white/90 text-sm font-medium tracking-wider">NORMAL MODE</p>
          </div>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl border-t border-gray-200 p-5">
          <button
            onClick={handleStart}
            className="w-full h-16 rounded-2xl bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 text-white font-black text-xl shadow-2xl hover:shadow-purple-500/50 active:scale-98 transition-all relative overflow-hidden group"
          >
